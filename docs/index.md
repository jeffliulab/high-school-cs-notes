...
-   **AP CSA**
    ...
    AP 计算机科学 A：2025 秋季新版四单元考纲，Java 面向对象编程入门到考试冲刺
...
-   **USACO Gold**
    ...
    金级：动态规划、最短路、并查集、最小生成树、树形 DP、数据结构
